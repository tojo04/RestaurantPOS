        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/register"
                className="bg-primary-500 text-white px-8 py-4 rounded-lg hover:bg-primary-600 transition-all duration-200 font-semibold text-lg inline-flex items-center justify-center group"
              >
                Start Free Trial
            ...
            {[
              {
                ...
                content: 'RestaurantPOS transformed our operations. Order accuracy improved by 40% and our staff loves how easy it is to use.',
                rating: 5
              },
              {
                name: 'Mike Chen',
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 RestaurantPOS. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
